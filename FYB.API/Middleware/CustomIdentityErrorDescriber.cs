...
public class CustomIdentityErrorDescriber : IdentityErrorDescriber
{
    ...
    public override IdentityError PasswordRequiresNonAlphanumeric() { return new IdentityError { Code = nameof(PasswordRequiresNonAlphanumeric), Description = "Пароль мусить містити хоча б один спеціальний символ" }; }
