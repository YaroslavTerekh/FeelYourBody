...
namespace FYB.Data.Migrations
{
    ...
    [Migration("20230701160341_AddNewDeleteBehaviorToFiles")]
    partial class AddNewDeleteBehaviorToFiles
    {
            ...
            modelBuilder.Entity("FYB.Data.Entities.AppFile", b =>
                {
                    b.HasOne("FYB.Data.Entities.Coach", "Coach")
                        .WithOne("Avatar")
                        .HasForeignKey("FYB.Data.Entities.AppFile", "CoachId");

                    b.HasOne("FYB.Data.Entities.Coaching", "Coaching")
                        .WithOne("CoachingPhoto")
                        .HasForeignKey("FYB.Data.Entities.AppFile", "CoachingId");
