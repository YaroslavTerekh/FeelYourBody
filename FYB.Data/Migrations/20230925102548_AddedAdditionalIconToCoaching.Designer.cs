...
namespace FYB.Data.Migrations
{
    ...
    [Migration("20230925102548_AddedAdditionalIconToCoaching")]
    partial class AddedAdditionalIconToCoaching
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FYB.Data.Entities.CoachingDetails", b =>
                {
                    ...
                    b.Property<Guid>("CoachingDetailsParentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CoachingDetailsParentId");

                    b.ToTable("CoachingDetails");
                });

            modelBuilder.Entity("FYB.Data.Entities.CoachingDetailsParent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CoachingDetailParents");
                });
            ...
            modelBuilder.Entity("FYB.Data.Entities.FoodPoint", b =>
                {
                    ...
                    b.Property<string>("CoockingMethod")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<Guid>("FoodPointsParentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FoodPointsParentId");

                    b.ToTable("FoodPoints");
                });

            modelBuilder.Entity("FYB.Data.Entities.FoodPointParent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FYB.Data.Entities.CoachingDetails", b =>
                {
                    b.HasOne("FYB.Data.Entities.CoachingDetailsParent", "CoachingDetailsParent")
                        .WithMany("Details")
                        .HasForeignKey("CoachingDetailsParentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CoachingDetailsParent");
                });

            modelBuilder.Entity("FYB.Data.Entities.CoachingDetailsParent", b =>
                {
                    b.HasOne("FYB.Data.Entities.Coaching", "Coaching")
                        .WithMany("CoachingDetailParents")
            ...
            modelBuilder.Entity("FYB.Data.Entities.FoodPoint", b =>
                {
                    b.HasOne("FYB.Data.Entities.FoodPointParent", "FoodPointsParent")
                        .WithMany("FoodPoints")
                        .HasForeignKey("FoodPointsParentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FoodPointsParent");
                });

            modelBuilder.Entity("FYB.Data.Entities.FoodPointParent", b =>
                {
                    b.HasOne("FYB.Data.Entities.Food", "Food")
                        .WithMany("FoodPointParents")
            ...
            modelBuilder.Entity("FYB.Data.Entities.Coaching", b =>
                {
                    b.Navigation("CoachingDetailParents");
